        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
          ...
          <div className="bg-gray-800 p-6">
            ...
            <p className="text-gray-300">
              Search and scrape tweets from the Philippines with content
              filtering
            </p>
          </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-4">
                <button
                  ...
                  className="flex-1 bg-gray-800 text-white py-2 px-4 rounded-lg hover:bg-gray-700 disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors font-medium"
                >
                      ...
                      <div className="flex justify-between items-start">
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-gray-600 mt-1">
                            {task.tweets_collected} / {task.limit} tweets
                            collected
                          </p>
                        </div>
                        <span
